...
export class FileStorageComponent implements OnInit, AfterViewInit {
  ...
  tableHeader: any = [
   // { field: 'fileNo', header: this.TempField, index: 1 },
    { field: 'userId', header: 'Uplaod By', index: 1 },
    { field: 'entryDate', header: 'Upload On', index: 2 },
    { field: 'fileSize', header: 'File Size', index: 3 },
    { field: 'pageCount', header: 'Page Count', index: 4 },
    { field: 'Version', header: 'Version', index: 5 }
 ...
 */
  ...
  prepareTableData(data) {
    var formattedData = [];
    this.metadataList = this.metadataList.slice(0,6);
