...
refresh()
{
  ...
  GetFileInfo(fileInfo: any, isNodeSelect?) {
    ...
    this.selectedRows = [];
    const apiUrl = this._global.baseAPIUrl + 'Status/GetFileStorageDataByGlobalSearch?UserID=' + localStorage.getItem('UserID') + '&FileNo=' + fileInfo.fileNo + '&parentFileNo=' + fileInfo.parentFileNo + '&user_Token=' + localStorage.getItem('User_Token')+ '&TemplateID=' + this.FileStorageForm.get('TemplateID').value
...
//this.modalRef.hide
  ...
  GetFilterSearch(tempID:any) {


    // alert(this.ContentSearchForm.get('TemplateID').value);
    var VarTempIDList =this.FileStorageForm.get('TemplateID').value;
    //var TempIDList =[];
    let selectedFileNames = '';
...
const apiUrl = this._global.baseAPIUrl + 'SearchFileStatus/GetGlobalSearch';
